...
function Contact() {
  ...
  function openMail() {
    window.open("mailto: greatyanat@gmail.com");
  }

  function openInstagram() {
    window.open("https://www.instagram.com/greatyanat/");
  }

  function copyPhoneNumber() {
    navigator.clipboard.writeText("081-154-0688");
  }
  ...
  return (
    <div className="contact-container">
        ...
        onClick={toggleDropdown}>Contact</button>
      {isDropdownOpen && (
